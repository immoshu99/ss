...
urlpatterns = [
    ...
    path('reset/<uidb64>/<token>/',auth_views.PasswordResetConfirmView.as_view(template_name='home/password_reset_confirm.html' ,success_url = reverse_lazy('myapp:login')),name='password_reset_confirm'),
